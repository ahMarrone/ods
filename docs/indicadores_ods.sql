...
--
-- Servidor: localhost
-- Tiempo de generación: 22-11-2016 a las 11:20:20
...
CREATE TABLE IF NOT EXISTS `indicadores` (
  ...
  `fechasDestacadas` varchar(50) COLLATE utf8_spanish_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `valoresIndicadores` (
  ...
  `idUsuario` int(11) unsigned NOT NULL,
  `fechaModificacion` datetime NOT NULL,
  PRIMARY KEY (`idIndicador`,`fecha`,`idRefGeografica`,`idEtiqueta`),
  KEY `idIndicadorFecha` (`idIndicador`, `fecha`),
